	...
	public class GameBackground extends Sprite
	{
		...
		private function onEnterFrame(event:Event):void
		{
			if (!gamePaused)
			{
				...
				// Background 1 - Sky
				bgLayer1.x -= Math.ceil(GameConstants.SCREEN_MOVE_SPEED * bgLayer1.parallaxDepth);
				// Hero flying left
				...
				// Background 2 - Hills
				//bgLayer2.x -= Math.ceil(GameConstants.SCREEN_MOVE_SPEED * bgLayer2.parallaxDepth);
				// Hero flying left
				...
				bgLayer3.x -= Math.ceil(GameConstants.SCREEN_MOVE_SPEED * bgLayer3.parallaxDepth);
				// Hero flying left
				...
				// Background 4 - Trees
				bgLayer4.x -= Math.ceil(GameConstants.SCREEN_MOVE_SPEED * bgLayer4.parallaxDepth);
				// Hero flying left
